...
Shader "NMP/Mineral 1" {
    Properties {
        ...
        _Bumpiness ("Bumpiness", Range(0, 0.5)) = 0.08022088
        _NormalSharpness ("Normal Sharpness", Range(0, 1)) = 0.6516593
        _Shadows ("Shadows", Range(0, 1)) = 0.9349673
        _Gloss ("Gloss", Range(0, 1)) = 0.7431703
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 specularColor = (_Specular_var.rgb*0.4);
                ...
                float3 indirectSpecular = (gi.indirect.specular + (_Specular_var.rgb*0.02));
                ...
                float3 node_8188 = saturate(((_Color.rgb*_MainTexture_var.rgb)*_Shadows));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _Specular_var = tex2D(_Specular,TRANSFORM_TEX(i.uv0, _Specular));
                float3 specColor = (_Specular_var.rgb*0.4);
