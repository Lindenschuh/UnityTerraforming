...
namespace Invector
{
    public class vSpike : MonoBehaviour
    {
        ...
        {
            if (collision.rigidbody != null && collision.collider.GetComponent<vCharacterController.vCollisionMessage>() != null && !inConect)
            {
                ...
                if (condition)
                {
                    ...
                    var ichar = collision.collider.GetComponent<vCharacterController.vCollisionMessage>();
                    if (ichar)
                        ichar.ragdoll.iChar.ChangeHealth((int)-ichar.ragdoll.iChar.currentHealth);
                }
            }
        }
